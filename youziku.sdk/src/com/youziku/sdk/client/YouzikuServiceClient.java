...
public class YouzikuServiceClient extends BaseServiceClient implements IYouzikuServiceClient {
	...
	public BatchCustomPathFontFaceResult getCustomPathBatchWoffWebFont(
		...
		String paramStr = ParamBuilder.getCustomPathFontFace(batchCustomPathWoffFontFace, _config);
		return commonGetFontFace(paramStr, _config.getHost()+ServiceMethod.CustomPath.CreateBatchWoffWebFont, _config,BatchCustomPathFontFaceResult.class);
	}

	public BatchCustomPathFontFaceResult getCustomPathBatchWebFont(
			BatchCustomPathWoffFontFaceParam batchCustomPathWoffFontFace) {
		String paramStr = ParamBuilder.getCustomPathFontFace(batchCustomPathWoffFontFace, _config);
		return commonGetFontFace(paramStr, _config.getHost()+ServiceMethod.CustomPath.CreateBatchWebFont, _config,BatchCustomPathFontFaceResult.class);
	}
